                    ...
                    <React.Fragment>
                        ...
                        <div className='flex items-center justify-center h-screen'>
                            ...
                            <h2 className='text-black text-lg font-bold mb-4'>Navigate Crypto Realms</h2>
                                <p className='text-black text-center mb-4 font-serif'>Dive into the Note App, Where Every Entry Sparks Reflection, and Your Digital Journaling Begins with Unmatched Simplicity!</p>
